...
import calculateAvgRating from './../utils/avgRating'; // Corrected the path to utils
...
const TourDetails = () => {
    ...
    const options = { day: "numeric", month: "long", year: "numeric" }; // Corrected the spelling of 'numeric'
